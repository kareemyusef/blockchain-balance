...
public class Deposit {
    @InitiatingFlow
    @StartableByRPC
    public static class DepositInitiator extends FlowLogic<SignedTransaction>{
        /**
         * Flow Parameters
        ...
        public DepositInitiator(UniqueIdentifier balanceId, double amount) throws IllegalArgumentException {
            if (!(amount > 0)) {
